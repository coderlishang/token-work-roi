...
export const OFFICIAL_PRICE_TABLE = [
  ...
  officialRate({
    ...
    input: 0.6245686572710721,
    cachedInput: 0.6245686572710721,
    cacheWrite5m: 0.6245686572710721,
    cacheWrite1h: 0.6245686572710721,
    output: 2.4982746290842885,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":4.2,"output":16.8,"cachedInput":4.2,"cacheWrite5m":4.2,"cacheWrite1h":4.2},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    input: 0.1487068231597791,
    cachedInput: 0.037176705789944774,
    cacheWrite5m: 0.1487068231597791,
    cacheWrite1h: 0.1487068231597791,
    output: 0.5948272926391164,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":1,"output":4,"cachedInput":0.25,"cacheWrite5m":1,"cacheWrite1h":1},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
  ...
  officialRate({
    ...
    input: 0.8922409389586745,
    cachedInput: 0.04461204694793373,
    cacheWrite5m: 0.8922409389586745,
    cacheWrite1h: 0.8922409389586745,
    output: 2.6767228168760235,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6,"output":18,"cachedInput":0.3,"cacheWrite5m":6,"cacheWrite1h":6},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "Tencent Hunyuan",
  ...
  officialRate({
    ...
    model: "glm-5.3",
    aliases: ["glm-5-3"],
    input: 1.1896545852782328,
    cachedInput: 0.2974136463195582,
    cacheWrite5m: 1.1896545852782328,
    cacheWrite1h: 1.1896545852782328,
    output: 4.163791048473814,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":8,"output":28,"cachedInput":2,"cacheWrite5m":8,"cacheWrite1h":8},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
  ...
  officialRate({
    ...
    input: 0.11896545852782328,
    cachedInput: 0.03420256932674919,
    cacheWrite5m: 0.11896545852782328,
    cacheWrite1h: 0.11896545852782328,
    output: 0.4163791048473814,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":0.8,"output":2.8,"cachedInput":0.23,"cacheWrite5m":0.8,"cacheWrite1h":0.8},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
  ...
  officialRate({
    ...
    input: 0.2974136463195582,
    cachedInput: 0.08476288920107407,
    cacheWrite5m: 0.2974136463195582,
    cacheWrite1h: 0.2974136463195582,
    output: 1.0409477621184535,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":2,"output":7,"cachedInput":0.57,"cacheWrite5m":2,"cacheWrite1h":2},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel RMB rate converted to USD at the last verified refresh rate."
  }),
  officialRate({
  ...
  officialRate({
    ...
    aliases: ["glm-5-1"],
    input: 0.8922409389586745,
    cachedInput: 0.19331887010771281,
    cacheWrite5m: 0.8922409389586745,
    cacheWrite1h: 0.8922409389586745,
    output: 3.568963755834698,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6,"output":24,"cachedInput":1.3,"cacheWrite5m":6,"cacheWrite1h":6},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
  ...
  officialRate({
    ...
    aliases: ["glm-4-5-air"],
    input: 0.11896545852782328,
    cachedInput: 0.023793091705564654,
    cacheWrite5m: 0.11896545852782328,
    cacheWrite1h: 0.11896545852782328,
    output: 0.2974136463195582,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":0.8,"output":2,"cachedInput":0.16,"cacheWrite5m":0.8,"cacheWrite1h":0.8},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    aliases: ["glm-4-7"],
    input: 0.2974136463195582,
    cachedInput: 0.05948272926391164,
    cacheWrite5m: 0.2974136463195582,
    cacheWrite1h: 0.2974136463195582,
    output: 1.1896545852782328,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":2,"output":8,"cachedInput":0.4,"cacheWrite5m":2,"cacheWrite1h":2},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    model: "glm-5",
    aliases: ["glm-5"],
    input: 0.5948272926391164,
    cachedInput: 0.1487068231597791,
    cacheWrite5m: 0.5948272926391164,
    cacheWrite1h: 0.5948272926391164,
    output: 2.6767228168760235,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":4,"output":18,"cachedInput":1,"cacheWrite5m":4,"cacheWrite1h":4},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    model: "glm-5-turbo",
    aliases: ["glm-5-turbo"],
    input: 0.7435341157988954,
    cachedInput: 0.1784481877917349,
    cacheWrite5m: 0.7435341157988954,
    cacheWrite1h: 0.7435341157988954,
    output: 3.27155010951514,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":5,"output":22,"cachedInput":1.2,"cacheWrite5m":5,"cacheWrite1h":5},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
  ...
  officialRate({
    ...
    aliases: ["glm-4-6v"],
    input: 0.1487068231597791,
    cachedInput: 0.02974136463195582,
    cacheWrite5m: 0.1487068231597791,
    cacheWrite1h: 0.1487068231597791,
    output: 0.44612046947933726,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":1,"output":3,"cachedInput":0.2,"cacheWrite5m":1,"cacheWrite1h":1},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
  ...
  officialRate({
    ...
    input: 0.022306023473966863,
    cachedInput: 0.004461204694793372,
    cacheWrite5m: 0.022306023473966863,
    cacheWrite1h: 0.022306023473966863,
    output: 0.22306023473966863,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":0.15,"output":1.5,"cachedInput":0.03,"cacheWrite5m":0.15,"cacheWrite1h":0.15},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page rate for input length [0, 32K]. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    cacheWrite1h: 0,
    output: 0,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":0,"output":0,"cachedInput":0,"cacheWrite5m":0,"cacheWrite1h":0},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
  ...
  officialRate({
    ...
    cacheWrite5m: 0.2974136463195582,
    cacheWrite1h: 0.2974136463195582,
    output: 0.8922409389586745,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":2,"output":6,"cachedInput":0.4,"cacheWrite5m":2,"cacheWrite1h":2},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page rate for input length [0, 32K]. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    cacheWrite5m: 0,
    cacheWrite1h: 0,
    output: 4.461204694793373,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6,"output":30,"cachedInput":1.2,"cacheWrite5m":0,"cacheWrite1h":0},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "DoubaoSeed",
  ...
  officialRate({
    ...
    input: 0.44612046947933726,
    cachedInput: 0.08922409389586745,
    cacheWrite5m: 0,
    cacheWrite1h: 0,
    output: 2.2306023473966863,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":3,"output":15,"cachedInput":0.6,"cacheWrite5m":0,"cacheWrite1h":0},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "DoubaoSeed",
    note: "Official Volcengine Ark CNY online-inference rate converted to USD at the last verified refresh rate. Cache-storage charges are not included."
  }),
  officialRate({
  ...
  officialRate({
    ...
    input: 0.08922409389586745,
    cachedInput: 0.01784481877917349,
    cacheWrite5m: 0,
    cacheWrite1h: 0,
    output: 0.5353445633752048,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":0.6,"output":3.6,"cachedInput":0.12000000000000001,"cacheWrite5m":0,"cacheWrite1h":0},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "DoubaoSeed",
  ...
  officialRate({
    ...
    aliases: ["doubao-seed-2-0-code", "doubao_seed_2_0_code"],
    input: 0.4758618341112931,
    cachedInput: 0.09517236682225862,
    cacheWrite5m: 0,
    cacheWrite1h: 0,
    output: 2.3793091705564655,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":3.2,"output":16,"cachedInput":0.64,"cacheWrite5m":0,"cacheWrite1h":0},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "DoubaoSeed",
    note: "Official Volcengine Ark regular online-inference rate for input length [0, 32K], converted to USD at the last verified refresh rate. Longer requests use higher tiered rates and are not distinguished by the local usage format."
  }),
  officialRate({
    ...
    aliases: ["doubao-seed-2-0-pro", "doubao_seed_2_0_pro"],
    input: 0.4758618341112931,
    cachedInput: 0.09517236682225862,
    cacheWrite5m: 0,
    cacheWrite1h: 0,
  ...
  officialRate({
    ...
    aliases: ["doubao-seed-2-0-mini", "doubao_seed_2_0_mini"],
    input: 0.02974136463195582,
    cachedInput: 0.0059482729263911635,
    cacheWrite5m: 0,
    cacheWrite1h: 0,
    output: 0.2974136463195582,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":0.2,"output":2,"cachedInput":0.04,"cacheWrite5m":0,"cacheWrite1h":0},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "DoubaoSeed",
    note: "Official Volcengine Ark regular online-inference rate for input length [0, 32K], converted to USD at the last verified refresh rate. Longer requests use higher tiered rates and are not distinguished by the local usage format."
  }),
  officialRate({
  ...
  officialRate({
    ...
    model: "kimi-k3",
    aliases: ["kimi-k3"],
    input: 5.948272926391163,
    cachedInput: 2.9741364631955816,
    cacheWrite5m: 5.948272926391163,
    cacheWrite1h: 5.948272926391163,
    output: 0.2974136463195582,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":40,"cachedInput":20,"cacheWrite5m":40,"cacheWrite1h":40,"output":2},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
  ...
  officialRate({
    ...
    input: 0.966594350538564,
    cachedInput: 0.19331887010771281,
    cacheWrite5m: 0.966594350538564,
    cacheWrite1h: 0.966594350538564,
    output: 4.015084225314035,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6.5,"cachedInput":1.3,"cacheWrite5m":6.5,"cacheWrite1h":6.5,"output":27},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    input: 1.933188701077128,
    cachedInput: 0.38663774021542563,
    cacheWrite5m: 1.933188701077128,
    cacheWrite1h: 1.933188701077128,
    output: 8.03016845062807,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":13,"cachedInput":2.6,"cacheWrite5m":13,"cacheWrite1h":13,"output":54},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    aliases: ["kimi-k2-6"],
    input: 0.966594350538564,
    cachedInput: 0.163577505475757,
    cacheWrite5m: 0.966594350538564,
    cacheWrite1h: 0.966594350538564,
    output: 4.015084225314035,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6.5,"cachedInput":1.1,"cacheWrite5m":6.5,"cacheWrite1h":6.5,"output":27},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    aliases: ["kimi-k2-5"],
    input: 0.5948272926391164,
    cachedInput: 0.10409477621184535,
    cacheWrite5m: 0.5948272926391164,
    cacheWrite1h: 0.5948272926391164,
    output: 3.122843286355361,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":4,"cachedInput":0.7,"cacheWrite5m":4,"cacheWrite1h":4,"output":21},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    input: 1.784481877917349,
    cachedInput: 1.784481877917349,
    cacheWrite5m: 1.784481877917349,
    cacheWrite1h: 1.784481877917349,
    output: 5.353445633752047,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":12,"output":36,"cachedInput":12,"cacheWrite5m":12,"cacheWrite1h":12},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
    note: "Official Alibaba Cloud Model Studio RMB prices converted to USD for internal cost math; short-context public rates are used by default."
  }),
  officialRate({
    ...
    input: 0.11896545852782328,
    cachedInput: 0.11896545852782328,
    cacheWrite5m: 0.11896545852782328,
    cacheWrite1h: 0.11896545852782328,
    output: 0.40150842253140356,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":0.8,"output":2.7,"cachedInput":0.8,"cacheWrite5m":0.8,"cacheWrite1h":0.8},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
    note: "Official Alibaba Cloud Model Studio RMB prices converted to USD for internal cost math; short-context public rates are used by default."
  }),
  officialRate({
    ...
    cacheWrite1h: 0.2974136463195582,
    output: 1.1896545852782328,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":2,"output":8,"cachedInput":2,"cacheWrite5m":2,"cacheWrite1h":2},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    input: 0.1784481877917349,
    cachedInput: 0.1784481877917349,
    cacheWrite5m: 0.1784481877917349,
    cacheWrite1h: 0.1784481877917349,
    output: 1.0706891267504095,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":1.2,"output":7.2,"cachedInput":1.2,"cacheWrite5m":1.2,"cacheWrite1h":1.2},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
    note: "Official Alibaba Cloud Model Studio RMB rate converted to USD at the last verified refresh rate."
  }),
  officialRate({
    ...
    input: 0.5948272926391164,
    cachedInput: 0.5948272926391164,
    cacheWrite5m: 0.5948272926391164,
    cacheWrite1h: 0.5948272926391164,
    output: 2.3793091705564655,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":4,"output":16,"cachedInput":4,"cacheWrite5m":4,"cacheWrite1h":4},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    cacheWrite1h: 0.1487068231597791,
    output: 0.5948272926391164,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":1,"output":4,"cachedInput":1,"cacheWrite5m":1,"cacheWrite1h":1},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
    note: "Official Alibaba Cloud Model Studio RMB short-context Coder rate converted to USD at the last verified refresh rate."
  }),
  officialRate({
    ...
    input: 0.5204738810592268,
    cachedInput: 0.5204738810592268,
    cacheWrite5m: 0.5204738810592268,
    cacheWrite1h: 0.5204738810592268,
    output: 1.0409477621184535,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":3.5,"output":7,"cachedInput":3.5,"cacheWrite5m":3.5,"cacheWrite1h":3.5},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    cacheWrite1h: 0.2974136463195582,
    output: 0.8922409389586745,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":2,"output":6,"cachedInput":2,"cacheWrite5m":2,"cacheWrite1h":2},"exchangeRate":6.724641,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
    note: "Official Alibaba Cloud Model Studio RMB Coder rate converted to USD at the last verified refresh rate."
  })
];
