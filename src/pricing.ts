...
export const OFFICIAL_PRICE_TABLE = [
  ...
  officialRate({
    ...
    input: 0.6259126029290922,
    cachedInput: 0.6259126029290922,
    cacheWrite5m: 0.6259126029290922,
    cacheWrite1h: 0.6259126029290922,
    output: 2.503650411716369,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":4.2,"output":16.8,"cachedInput":4.2,"cacheWrite5m":4.2,"cacheWrite1h":4.2},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    input: 0.14902681022121242,
    cachedInput: 0.037256702555303105,
    cacheWrite5m: 0.14902681022121242,
    cacheWrite1h: 0.14902681022121242,
    output: 0.5961072408848497,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":1,"output":4,"cachedInput":0.25,"cacheWrite5m":1,"cacheWrite1h":1},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
  ...
  officialRate({
    ...
    input: 0.8941608613272746,
    cachedInput: 0.04470804306636372,
    cacheWrite5m: 0.8941608613272746,
    cacheWrite1h: 0.8941608613272746,
    output: 2.6824825839818236,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6,"output":18,"cachedInput":0.3,"cacheWrite5m":6,"cacheWrite1h":6},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "Tencent Hunyuan",
  ...
  officialRate({
    ...
    model: "glm-5.3",
    aliases: ["glm-5-3"],
    input: 1.1922144817696994,
    cachedInput: 0.29805362044242484,
    cacheWrite5m: 1.1922144817696994,
    cacheWrite1h: 1.1922144817696994,
    output: 4.172750686193948,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":8,"output":28,"cachedInput":2,"cacheWrite5m":8,"cacheWrite1h":8},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
  ...
  officialRate({
    ...
    input: 0.11922144817696995,
    cachedInput: 0.03427616635087886,
    cacheWrite5m: 0.11922144817696995,
    cacheWrite1h: 0.11922144817696995,
    output: 0.41727506861939473,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":0.8,"output":2.8,"cachedInput":0.23,"cacheWrite5m":0.8,"cacheWrite1h":0.8},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
  ...
  officialRate({
    ...
    input: 0.29805362044242484,
    cachedInput: 0.08494528182609107,
    cacheWrite5m: 0.29805362044242484,
    cacheWrite1h: 0.29805362044242484,
    output: 1.043187671548487,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":2,"output":7,"cachedInput":0.57,"cacheWrite5m":2,"cacheWrite1h":2},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel RMB rate converted to USD at the last verified refresh rate."
  }),
  officialRate({
  ...
  officialRate({
    ...
    aliases: ["glm-5-1"],
    input: 0.8941608613272746,
    cachedInput: 0.19373485328757614,
    cacheWrite5m: 0.8941608613272746,
    cacheWrite1h: 0.8941608613272746,
    output: 3.5766434453090983,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6,"output":24,"cachedInput":1.3,"cacheWrite5m":6,"cacheWrite1h":6},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
  ...
  officialRate({
    ...
    aliases: ["glm-4-5-air"],
    input: 0.11922144817696995,
    cachedInput: 0.02384428963539399,
    cacheWrite5m: 0.11922144817696995,
    cacheWrite1h: 0.11922144817696995,
    output: 0.29805362044242484,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":0.8,"output":2,"cachedInput":0.16,"cacheWrite5m":0.8,"cacheWrite1h":0.8},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    aliases: ["glm-4-7"],
    input: 0.29805362044242484,
    cachedInput: 0.05961072408848497,
    cacheWrite5m: 0.29805362044242484,
    cacheWrite1h: 0.29805362044242484,
    output: 1.1922144817696994,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":2,"output":8,"cachedInput":0.4,"cacheWrite5m":2,"cacheWrite1h":2},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    model: "glm-5",
    aliases: ["glm-5"],
    input: 0.5961072408848497,
    cachedInput: 0.14902681022121242,
    cacheWrite5m: 0.5961072408848497,
    cacheWrite1h: 0.5961072408848497,
    output: 2.6824825839818236,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":4,"output":18,"cachedInput":1,"cacheWrite5m":4,"cacheWrite1h":4},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    model: "glm-5-turbo",
    aliases: ["glm-5-turbo"],
    input: 0.7451340511060621,
    cachedInput: 0.1788321722654549,
    cacheWrite5m: 0.7451340511060621,
    cacheWrite1h: 0.7451340511060621,
    output: 3.2785898248666734,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":5,"output":22,"cachedInput":1.2,"cacheWrite5m":5,"cacheWrite1h":5},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
  ...
  officialRate({
    ...
    aliases: ["glm-4-6v"],
    input: 0.14902681022121242,
    cachedInput: 0.029805362044242487,
    cacheWrite5m: 0.14902681022121242,
    cacheWrite1h: 0.14902681022121242,
    output: 0.4470804306636373,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":1,"output":3,"cachedInput":0.2,"cacheWrite5m":1,"cacheWrite1h":1},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
  ...
  officialRate({
    ...
    input: 0.02235402153318186,
    cachedInput: 0.004470804306636373,
    cacheWrite5m: 0.02235402153318186,
    cacheWrite1h: 0.02235402153318186,
    output: 0.22354021533181864,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":0.15,"output":1.5,"cachedInput":0.03,"cacheWrite5m":0.15,"cacheWrite1h":0.15},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page rate for input length [0, 32K]. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    cacheWrite1h: 0,
    output: 0,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":0,"output":0,"cachedInput":0,"cacheWrite5m":0,"cacheWrite1h":0},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
  ...
  officialRate({
    ...
    cacheWrite5m: 0.29805362044242484,
    cacheWrite1h: 0.29805362044242484,
    output: 0.8941608613272746,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":2,"output":6,"cachedInput":0.4,"cacheWrite5m":2,"cacheWrite1h":2},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page rate for input length [0, 32K]. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    cacheWrite5m: 0,
    cacheWrite1h: 0,
    output: 4.4708043066363725,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6,"output":30,"cachedInput":1.2,"cacheWrite5m":0,"cacheWrite1h":0},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "DoubaoSeed",
  ...
  officialRate({
    ...
    input: 0.4470804306636373,
    cachedInput: 0.08941608613272745,
    cacheWrite5m: 0,
    cacheWrite1h: 0,
    output: 2.2354021533181863,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":3,"output":15,"cachedInput":0.6,"cacheWrite5m":0,"cacheWrite1h":0},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "DoubaoSeed",
    note: "Official Volcengine Ark CNY online-inference rate converted to USD at the last verified refresh rate. Cache-storage charges are not included."
  }),
  officialRate({
  ...
  officialRate({
    ...
    input: 0.08941608613272745,
    cachedInput: 0.01788321722654549,
    cacheWrite5m: 0,
    cacheWrite1h: 0,
    output: 0.5364965167963647,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":0.6,"output":3.6,"cachedInput":0.12,"cacheWrite5m":0,"cacheWrite1h":0},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "DoubaoSeed",
  ...
  officialRate({
    ...
    model: "kimi-k3",
    aliases: ["kimi-k3"],
    input: 5.961072408848497,
    cachedInput: 2.9805362044242485,
    cacheWrite5m: 5.961072408848497,
    cacheWrite1h: 5.961072408848497,
    output: 0.29805362044242484,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":40,"cachedInput":20,"cacheWrite5m":40,"cacheWrite1h":40,"output":2},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
  ...
  officialRate({
    ...
    input: 0.9686742664378808,
    cachedInput: 0.19373485328757614,
    cacheWrite5m: 0.9686742664378808,
    cacheWrite1h: 0.9686742664378808,
    output: 4.023723875972736,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6.5,"cachedInput":1.3,"cacheWrite5m":6.5,"cacheWrite1h":6.5,"output":27},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    input: 1.9373485328757616,
    cachedInput: 0.3874697065751523,
    cacheWrite5m: 1.9373485328757616,
    cacheWrite1h: 1.9373485328757616,
    output: 8.047447751945471,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":13,"cachedInput":2.6,"cacheWrite5m":13,"cacheWrite1h":13,"output":54},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    aliases: ["kimi-k2-6"],
    input: 0.9686742664378808,
    cachedInput: 0.16392949124333367,
    cacheWrite5m: 0.9686742664378808,
    cacheWrite1h: 0.9686742664378808,
    output: 4.023723875972736,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6.5,"cachedInput":1.1,"cacheWrite5m":6.5,"cacheWrite1h":6.5,"output":27},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    aliases: ["kimi-k2-5"],
    input: 0.5961072408848497,
    cachedInput: 0.10431876715484868,
    cacheWrite5m: 0.5961072408848497,
    cacheWrite1h: 0.5961072408848497,
    output: 3.129563014645461,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":4,"cachedInput":0.7,"cacheWrite5m":4,"cacheWrite1h":4,"output":21},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    input: 1.7883217226545491,
    cachedInput: 1.7883217226545491,
    cacheWrite5m: 1.7883217226545491,
    cacheWrite1h: 1.7883217226545491,
    output: 5.364965167963647,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":12,"output":36,"cachedInput":12,"cacheWrite5m":12,"cacheWrite1h":12},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
    note: "Official Alibaba Cloud Model Studio RMB prices converted to USD for internal cost math; short-context public rates are used by default."
  }),
  officialRate({
    ...
    cacheWrite1h: 0.29805362044242484,
    output: 1.1922144817696994,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":2,"output":8,"cachedInput":2,"cacheWrite5m":2,"cacheWrite1h":2},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    input: 0.1788321722654549,
    cachedInput: 0.1788321722654549,
    cacheWrite5m: 0.1788321722654549,
    cacheWrite1h: 0.1788321722654549,
    output: 1.0729930335927294,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":1.2,"output":7.2,"cachedInput":1.2,"cacheWrite5m":1.2,"cacheWrite1h":1.2},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
    note: "Official Alibaba Cloud Model Studio RMB rate converted to USD at the last verified refresh rate."
  }),
  officialRate({
    ...
    input: 0.5961072408848497,
    cachedInput: 0.5961072408848497,
    cacheWrite5m: 0.5961072408848497,
    cacheWrite1h: 0.5961072408848497,
    output: 2.3844289635393987,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":4,"output":16,"cachedInput":4,"cacheWrite5m":4,"cacheWrite1h":4},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    cacheWrite1h: 0.14902681022121242,
    output: 0.5961072408848497,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":1,"output":4,"cachedInput":1,"cacheWrite5m":1,"cacheWrite1h":1},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
    note: "Official Alibaba Cloud Model Studio RMB short-context Coder rate converted to USD at the last verified refresh rate."
  }),
  officialRate({
    ...
    input: 0.5215938357742435,
    cachedInput: 0.5215938357742435,
    cacheWrite5m: 0.5215938357742435,
    cacheWrite1h: 0.5215938357742435,
    output: 1.043187671548487,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":3.5,"output":7,"cachedInput":3.5,"cacheWrite5m":3.5,"cacheWrite1h":3.5},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    cacheWrite1h: 0.29805362044242484,
    output: 0.8941608613272746,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":2,"output":6,"cachedInput":2,"cacheWrite5m":2,"cacheWrite1h":2},"exchangeRate":6.710202,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
    note: "Official Alibaba Cloud Model Studio RMB Coder rate converted to USD at the last verified refresh rate."
  })
];
