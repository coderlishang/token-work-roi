...
export const OFFICIAL_PRICE_TABLE = [
  ...
  officialRate({
    ...
    input: 0.6245168358586861,
    cachedInput: 0.6245168358586861,
    cacheWrite5m: 0.6245168358586861,
    cacheWrite1h: 0.6245168358586861,
    output: 2.4980673434347445,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":4.2,"output":16.8,"cachedInput":4.2,"cacheWrite5m":4.2,"cacheWrite1h":4.2},"exchangeRate":6.725199,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    input: 0.1486944847282586,
    cachedInput: 0.03717362118206465,
    cacheWrite5m: 0.1486944847282586,
    cacheWrite1h: 0.1486944847282586,
    output: 0.5947779389130344,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":1,"output":4,"cachedInput":0.25,"cacheWrite5m":1,"cacheWrite1h":1},"exchangeRate":6.725199,"sourceUnit":"元 / 1M tokens"},
  ...
  officialRate({
    ...
    input: 0.8921669083695516,
    cachedInput: 0.04460834541847758,
    cacheWrite5m: 0.8921669083695516,
    cacheWrite1h: 0.8921669083695516,
    output: 2.6765007251086548,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6,"output":18,"cachedInput":0.3,"cacheWrite5m":6,"cacheWrite1h":6},"exchangeRate":6.725199,"sourceUnit":"元 / 1M tokens"},
    source: "Tencent Hunyuan",
  ...
  officialRate({
    ...
    model: "glm-5.3",
    aliases: ["glm-5-3"],
    input: 1.1895558778260689,
    cachedInput: 0.2973889694565172,
    cacheWrite5m: 1.1895558778260689,
    cacheWrite1h: 1.1895558778260689,
    output: 4.1634455723912405,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":8,"output":28,"cachedInput":2,"cacheWrite5m":8,"cacheWrite1h":8},"exchangeRate":6.725199,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
  ...
  officialRate({
    ...
    input: 0.05947779389130344,
    cachedInput: 0.01709986574374974,
    cacheWrite5m: 0.05947779389130344,
    cacheWrite1h: 0.05947779389130344,
    output: 0.20817227861956203,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":0.4,"output":1.4,"cachedInput":0.115,"cacheWrite5m":0.4,"cacheWrite1h":0.4},"exchangeRate":6.725199,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
  ...
  officialRate({
    ...
    aliases: ["glm-5-1"],
    input: 0.8921669083695516,
    cachedInput: 0.1933028301467362,
    cacheWrite5m: 0.8921669083695516,
    cacheWrite1h: 0.8921669083695516,
    output: 3.5686676334782064,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6,"output":24,"cachedInput":1.3,"cacheWrite5m":6,"cacheWrite1h":6},"exchangeRate":6.725199,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
  ...
  officialRate({
    ...
    model: "glm-4.5-air",
    aliases: ["glm-4-5-air"],
    input: 0.11895558778260688,
    cachedInput: 0.023791117556521378,
    cacheWrite5m: 0.11895558778260688,
    cacheWrite1h: 0.11895558778260688,
    output: 0.2973889694565172,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":0.8,"output":2,"cachedInput":0.16,"cacheWrite5m":0.8,"cacheWrite1h":0.8},"exchangeRate":6.725199,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    model: "glm-4.7",
    aliases: ["glm-4-7"],
    input: 0.2973889694565172,
    cachedInput: 0.05947779389130344,
    cacheWrite5m: 0.2973889694565172,
    cacheWrite1h: 0.2973889694565172,
    output: 1.1895558778260689,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":2,"output":8,"cachedInput":0.4,"cacheWrite5m":2,"cacheWrite1h":2},"exchangeRate":6.725199,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    model: "glm-5",
    aliases: ["glm-5"],
    input: 0.5947779389130344,
    cachedInput: 0.1486944847282586,
    cacheWrite5m: 0.5947779389130344,
    cacheWrite1h: 0.5947779389130344,
    output: 2.6765007251086548,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":4,"output":18,"cachedInput":1,"cacheWrite5m":4,"cacheWrite1h":4},"exchangeRate":6.725199,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    model: "glm-5-turbo",
    aliases: ["glm-5-turbo"],
    input: 0.743472423641293,
    cachedInput: 0.17843338167391032,
    cacheWrite5m: 0.743472423641293,
    cacheWrite1h: 0.743472423641293,
    output: 3.2712786640216893,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":5,"output":22,"cachedInput":1.2,"cacheWrite5m":5,"cacheWrite1h":5},"exchangeRate":6.725199,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
  ...
  officialRate({
    ...
    cacheWrite5m: 0,
    cacheWrite1h: 0,
    output: 4.460834541847758,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6,"output":30,"cachedInput":1.2,"cacheWrite5m":0,"cacheWrite1h":0},"exchangeRate":6.725199,"sourceUnit":"元 / 1M tokens"},
    source: "DoubaoSeed",
  ...
  officialRate({
    ...
    input: 0.4460834541847758,
    cachedInput: 0.08921669083695516,
    cacheWrite5m: 0,
    cacheWrite1h: 0,
    output: 2.230417270923879,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":3,"output":15,"cachedInput":0.6,"cacheWrite5m":0,"cacheWrite1h":0},"exchangeRate":6.725199,"sourceUnit":"元 / 1M tokens"},
    source: "DoubaoSeed",
    note: "Official Volcengine Ark CNY online-inference rate converted to USD at the last verified refresh rate. Cache-storage charges are not included."
  }),
  officialRate({
    ...
    input: 0.08921669083695516,
    cachedInput: 0.017843338167391032,
    cacheWrite5m: 0,
    cacheWrite1h: 0,
    output: 0.535300145021731,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":0.6,"output":3.6,"cachedInput":0.12,"cacheWrite5m":0,"cacheWrite1h":0},"exchangeRate":6.725199,"sourceUnit":"元 / 1M tokens"},
    source: "DoubaoSeed",
  ...
  officialRate({
    ...
    model: "kimi-k3",
    aliases: ["kimi-k3"],
    input: 2.973889694565172,
    cachedInput: 0.2973889694565172,
    cacheWrite5m: 2.973889694565172,
    cacheWrite1h: 2.973889694565172,
    output: 14.86944847282586,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":20,"cachedInput":2,"cacheWrite5m":20,"cacheWrite1h":20,"output":100},"exchangeRate":6.725199,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
  ...
  officialRate({
    ...
    input: 0.9665141507336809,
    cachedInput: 0.1933028301467362,
    cacheWrite5m: 0.9665141507336809,
    cacheWrite1h: 0.9665141507336809,
    output: 4.014751087662982,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6.5,"cachedInput":1.3,"cacheWrite5m":6.5,"cacheWrite1h":6.5,"output":27},"exchangeRate":6.725199,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    input: 1.9330283014673617,
    cachedInput: 0.3866056602934724,
    cacheWrite5m: 1.9330283014673617,
    cacheWrite1h: 1.9330283014673617,
    output: 8.029502175325964,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":13,"cachedInput":2.6,"cacheWrite5m":13,"cacheWrite1h":13,"output":54},"exchangeRate":6.725199,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    aliases: ["kimi-k2-6"],
    input: 0.9665141507336809,
    cachedInput: 0.16356393320108448,
    cacheWrite5m: 0.9665141507336809,
    cacheWrite1h: 0.9665141507336809,
    output: 4.014751087662982,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6.5,"cachedInput":1.1,"cacheWrite5m":6.5,"cacheWrite1h":6.5,"output":27},"exchangeRate":6.725199,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    aliases: ["kimi-k2-5"],
    input: 0.5947779389130344,
    cachedInput: 0.10408613930978101,
    cacheWrite5m: 0.5947779389130344,
    cacheWrite1h: 0.5947779389130344,
    output: 3.1225841792934306,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":4,"cachedInput":0.7,"cacheWrite5m":4,"cacheWrite1h":4,"output":21},"exchangeRate":6.725199,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    input: 1.7843338167391032,
    cachedInput: 1.7843338167391032,
    cacheWrite5m: 1.7843338167391032,
    cacheWrite1h: 1.7843338167391032,
    output: 5.3530014502173096,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":12,"output":36,"cachedInput":12,"cacheWrite5m":12,"cacheWrite1h":12},"exchangeRate":6.725199,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
    note: "Official Alibaba Cloud Model Studio RMB prices converted to USD for internal cost math; short-context public rates are used by default."
  }),
  officialRate({
    ...
    cacheWrite1h: 0.2973889694565172,
    output: 1.1895558778260689,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":2,"output":8,"cachedInput":2,"cacheWrite5m":2,"cacheWrite1h":2},"exchangeRate":6.725199,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    input: 0.17843338167391032,
    cachedInput: 0.17843338167391032,
    cacheWrite5m: 0.17843338167391032,
    cacheWrite1h: 0.17843338167391032,
    output: 1.070600290043462,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":1.2,"output":7.2,"cachedInput":1.2,"cacheWrite5m":1.2,"cacheWrite1h":1.2},"exchangeRate":6.725199,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
    note: "Official Alibaba Cloud Model Studio RMB rate converted to USD at the last verified refresh rate."
  }),
  officialRate({
    ...
    input: 0.5947779389130344,
    cachedInput: 0.5947779389130344,
    cacheWrite5m: 0.5947779389130344,
    cacheWrite1h: 0.5947779389130344,
    output: 2.3791117556521377,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":4,"output":16,"cachedInput":4,"cacheWrite5m":4,"cacheWrite1h":4},"exchangeRate":6.725199,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    cacheWrite1h: 0.1486944847282586,
    output: 0.5947779389130344,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":1,"output":4,"cachedInput":1,"cacheWrite5m":1,"cacheWrite1h":1},"exchangeRate":6.725199,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
    note: "Official Alibaba Cloud Model Studio RMB short-context Coder rate converted to USD at the last verified refresh rate."
  }),
  officialRate({
    ...
    input: 0.5204306965489051,
    cachedInput: 0.5204306965489051,
    cacheWrite5m: 0.5204306965489051,
    cacheWrite1h: 0.5204306965489051,
    output: 1.0408613930978101,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":3.5,"output":7,"cachedInput":3.5,"cacheWrite5m":3.5,"cacheWrite1h":3.5},"exchangeRate":6.725199,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    cacheWrite5m: 0.2973889694565172,
    cacheWrite1h: 0.2973889694565172,
    output: 0.8921669083695516,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":2,"output":6,"cachedInput":2,"cacheWrite5m":2,"cacheWrite1h":2},"exchangeRate":6.725199,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
    note: "Official Alibaba Cloud Model Studio RMB Coder rate converted to USD at the last verified refresh rate."
  })
];
